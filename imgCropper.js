var imageCrop=function(params){
    ...
    _pub.init=function(){
        ...
        console.log(_pub.img);
        console.log(_pub.container);
    };
    _pub.getImage = function() {
        var imgArray = _pub.container.getElementsByTagName(“img”),
        img = false;
    ...
    //git>sitema de versionamiento
    //github>redsocial de repositorio opensource
    return _pub;
};